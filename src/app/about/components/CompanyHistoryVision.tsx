              ...
              <div className="md:w-1/2 ml-20 md:ml-0 md:pr-16 md:text-right">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  ...
                  <p>
                    ...
                    with proven expertise in complex projects of all scales.
                  </p>
                </div>
              </div>
              ...
              <div className="md:w-1/2 ml-20 md:ml-16 md:text-left">
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    ...
                    offering our clients complete satisfaction.
                  </p>
                  <p>
                    Our commitment is rooted in <strong>quality, reliability, and trust</strong>.
                  </p>
                  <p>
                    We aim to be a <strong>world-class engineering company</strong>, 
                    delivering sustainable and affordable solutions.
                  </p>
                </div>
              </div>
