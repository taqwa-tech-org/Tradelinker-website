                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                            We deliver advanced engineering solutions tailored
                            for the food and agro industry, focusing on safety,
                            efficiency, and sustainable production. Our systems
                            help businesses maintain quality standards while
