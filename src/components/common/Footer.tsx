...
export default function Footer() {
  ...
  return (
      <footer className="bg-gradient-to-b from-pearl-aqua-500 to-pearl-aqua-800 text-white">
          <div className="container px-6 md:px-10 mx-auto pt-16">
              ...
              <Logo />
                      ...
                      <div className="space-y-3 text-sm text-pearl-aqua-200">
                          <div className="flex items-start gap-3">
                              <svg
                                  className="w-5 h-5 text-pearl-aqua-400 flex-shrink-0 mt-0.5"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                              >
                              ...
                              <div>
                                  <p className="font-medium">
                                      Road# 16A, House# 1B, Apartment# A3,
                                  </p>
                          ...
                          <div className="flex items-center gap-3">
                              <svg
                                  className="w-5 h-5 text-pearl-aqua-400 flex-shrink-0"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                              >
                  ...
                  <div className="hidden md:block">
                      <h4 className="text-lg font-bold mb-4 text-pearl-aqua-100">
                          Industries
                      </h4>
                  ...
                  <div>
                      ...
                      {/* Social Links */}
                      <div>
                          <h4 className="text-sm font-semibold mb-3 text-pearl-aqua-100">
                              Follow Us
                          </h4>
              ...
              <div className="mt-12 pt-8 border-t border-pearl-aqua-800">
                  <div className="text-center flex-col md:flex-row  gap-4 text-sm text-pearl-aqua-300">
                      <p className="pb-8">
                          © 2025 Tradelinkers Engineering Ltd. All rights
                          reserved.
                      </p>
                  </div>
              </div>
